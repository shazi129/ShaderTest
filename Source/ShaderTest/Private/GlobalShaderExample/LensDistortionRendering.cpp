...
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationVS, TEXT("/Plugin/ShaderTest/Private/GlobalShaderExample.usf"), TEXT("MainVS"), SF_Vertex)
IMPLEMENT_SHADER_TYPE(, FLensDistortionUVGenerationPS, TEXT("/Plugin/ShaderTest/Private/GlobalShaderExample.usf"), TEXT("MainPS"), SF_Pixel)
