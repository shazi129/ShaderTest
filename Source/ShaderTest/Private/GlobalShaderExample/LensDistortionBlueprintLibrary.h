...
class ULensDistortionBlueprintLibrary : public UBlueprintFunctionLibrary
{
	...
	UFUNCTION(BlueprintPure,  Category = "Foo | Lens Distortion", meta = (DeprecatedFunction, DeprecationMessage = "The LensDistortion plugin is deprecated. Please update your project to use the features of the CameraCalibration plugin."))
	...
	UFUNCTION(BlueprintPure, meta=(DeprecatedFunction, DeprecationMessage = "The LensDistortion plugin is deprecated. Please update your project to use the features of the CameraCalibration plugin.", DisplayName = "Equal (LensDistortionCameraModel)", CompactNodeTitle = "==", Keywords = "== equal"),  Category = "Foo | Lens Distortion")
	...
	UFUNCTION(BlueprintPure, meta = (DeprecatedFunction, DeprecationMessage = "The LensDistortion plugin is deprecated. Please update your project to use the features of the CameraCalibration plugin.", DisplayName = "NotEqual (LensDistortionCameraModel)", CompactNodeTitle = "!=", Keywords = "!= not equal"),  Category = "Foo | Lens Distortion")
